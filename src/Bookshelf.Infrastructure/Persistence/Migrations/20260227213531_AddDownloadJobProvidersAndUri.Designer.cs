...
namespace Bookshelf.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260227213531_AddDownloadJobProvidersAndUri")]
    partial class AddDownloadJobProvidersAndUri
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookshelf.Domain.Entities.BookRating", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_book_ratings_user_id");

                    b.ToTable("book_ratings", null, t =>
                        {
                            t.HasCheckConstraint("ck_book_ratings_rating", "rating >= 1 AND rating <= 5");
                        });
                });
